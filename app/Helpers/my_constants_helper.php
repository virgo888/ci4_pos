 ...
 */
if(! defined('T_PRODUCT')) define('T_PRODUCT', 'products');
if(! defined('T_PRODUCT_HISTORY')) define('T_PRODUCT_HISTORY', 'product_history');

if(! defined('T_CUSTOMER')) define('T_CUSTOMER', 'customer');
if(! defined('T_CUSTOMER_HISTORY')) define('T_CUSTOMER_HISTORY', 'customer_history');

if(! defined('T_SUPPLIER')) define('T_SUPPLIER', 'supplier');
if(! defined('T_SUPPLIER_HISTORY')) define('T_SUPPLIER_HISTORY', 'supplier_history');

if(! defined('T_PURCHASE')) define('T_PURCHASE', 'purchase');
if(! defined('T_PURCHASE_HISTORY')) define('T_PURCHASE_HISTORY', 'purchase_history');
if(! defined('T_PURCHASE_DETAIL')) define('T_PURCHASE_DETAIL', 'purchase_detail');
if(! defined('T_PURCHASE_DETAIL_HISTORY')) define('T_PURCHASE_DETAIL_HISTORY', 'purchase_detail_history');


if(! defined('T_SALES')) define('T_SALES', 'sales');
if(! defined('T_SALES_HISTORY')) define('T_SALES_HISTORY', 'sales_history');
...
if(! defined('ALIAS')) define('ALIAS', 'alias');
if(! defined('EMAIL')) define('EMAIL', 'email');
if(! defined('PROVINCE')) define('PROVINCE', 'province');
if(! defined('REGENCY')) define('REGENCY', 'regency');
if(! defined('DISTRICT')) define('DISTRICT', 'district');
if(! defined('VILLAGE')) define('VILLAGE', 'village');
if(! defined('ADDRESS')) define('ADDRESS', 'address');
if(! defined('PHONE')) define('PHONE', 'phone');
if(! defined('NOTES')) define('NOTES', 'notes');
if(! defined('REFERENCE')) define('REFERENCE', 'reference');
if(! defined('TOTAL')) define('TOTAL', 'total');
...
/**
 * DEFINE GLOBAL VARIABLE FOR PRODUCT
 */
if(! defined('ID_PRODUCT')) define('ID_PRODUCT', 'id_product');
if(! defined('SKU')) define('SKU', 'sku');
if(! defined('DESC')) define('DESC', 'desc');
if(! defined('PRICE_BUY')) define('PRICE_BUY', 'price_buy');
if(! defined('PRICE_SELL')) define('PRICE_SELL', 'price_sell');
